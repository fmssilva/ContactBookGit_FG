 ...
 * ferramenta JUnit. Estes testes usam como input os ficheiros de teste do
 * Mooshak, gerando, como output, o resultado esperado na execução desses
 * testes. A classe está implementada para os testes do problema do
 * contactBook.ContactBook, a usar na primeira aula prática de POO. No entanto,
 * a sua adaptação para os restantes problemas a realizar ao longo do semestre é
 * trivial. Para poder usar esta classe tem de incluir no seu ambiente de
 * execução a biblioteca JUnit 4. Veja como o pode fazer na primeira aula
 * prática do semestre!
 */
public class Tests {
	/**
	 ...
	 * apenas temos 3 testes para realizar. Para cada ficheiro de input, existe um
	 * ficheiro de output correspondente. Por exemplo, o resultado esperado para o
	 * teste 1_in_base.txt é 1_out_base.txt . Não tem de fazer mais nada no resto da
	 * classe. Basta configurar esta sequência de testes!
	 */
	@Test
	public void test1() {
