...
public class Main {
	...
	private static final String REPEATED_PHONE = "EP";
	...
	public static final String EXIST_DUP_NUMBERS = "There are contacts that share phone numbers.";
	public static final String DONT_EXIST_DUP_NUMBERS = "All contacts have different phone numbers.";
	...
	private static void hasRepeatedNum(ContactBook cBook) {
		if (cBook.hasRepeatedNum())
			System.out.println(EXIST_DUP_NUMBERS);
		else
			System.out.println(DONT_EXIST_DUP_NUMBERS);
	}
